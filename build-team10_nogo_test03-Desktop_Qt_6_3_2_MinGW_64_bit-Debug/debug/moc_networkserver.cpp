...
#include <memory>
#include "../../team10_nogo/network/networkserver.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NetworkServer_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject NetworkServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetworkServer.offsetsAndSizes,
