...
#include <memory>
#include "../../team10_nogo/network/networksocket.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_NetworkSocket_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject NetworkSocket::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetworkSocket.offsetsAndSizes,
